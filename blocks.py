...
breakable = set([BLOCK, RBLOCK, GROUND, PEBBL, CORE, GOLD])
breakto = {SKY:SKY,BLOCK:BACKG,RBLOCK:SKY,GROUND:SKY,BACKG:BACKG,PEBBL:STNBACK,CORE:STNBACK,STNBACK:STNBACK,GOLD:SKY,GWALL:GWALL,WINDOW:WINDOW}
...
def loadBlocks(size):
    ...
    blocks = { SKY:sky, BLOCK:block, RBLOCK:rblock, GROUND:ground,
               BACKG:backg, PEBBL:pebbl, CORE:core, STNBACK:stnback, GOLD:gold, GWALL:gwall, WINDOW:window}
    bn={SKY:"sky",BLOCK:"asdf",RBLOCK:"redstuff",
        GROUND:"ground",BACKG:"asdf background",PEBBL:"stone",CORE:"coal ore",STNBACK:"stone background",GOLD:"gold block",GWALL:"golden wall",WINDOW:"window"}
